;;; pdx-carpet-dark-theme.el --- Theme 
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'pdx-carpet-dark
	...
	`(font-lock-constant-face ((,class (:foreground ,const))))
        ...
        `(font-lock-type-face ((,class (:bold ,class :foreground ,type ))))
        `(font-lock-variable-name-face ((,class (:foreground ,var))))
        `(font-lock-warning-face ((,class (:foreground ,warning :background ,bg2))))
        `(term-color-black ((,class (:foreground ,fg2 :background nil))))
        `(region ((,class (:background ,keyword :foreground ,fg1))))
...
(provide-theme 'pdx-carpet-dark)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; pdx-carpet-dark-theme.el ends here
